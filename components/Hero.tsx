    ...
    >
      ...
      <div className="py-16 lg:py-48 flex flex-col-reverse lg:flex-row justify-around gap-10 lg:gap-0">
        <div className="flex flex-col gap-4 md:gap-6 text-left lg:w-1/2 2xl:w-1/3 mx-4 md:mx-6 xl:mx-0">
          <div className="flex items-center gap-1">
            <Image
              ...
              src={wavingHand}
            />
            <p className="text-lg md:text-xl mt-2 md:mt-1.5">Hello</p>
          </div>
        ...
        <div className="relative mx-auto lg:mx-0 mt-12 md:mt-16 lg:mt-0">
          ...
          <div className="absolute grid -top-6 -left-12 lg:-top-14 lg:-left-1 w-16 h-16 md:w-20 md:h-20 bg-white dark:bg-grey-800 rounded-full place-items-center hover:shadow-lg transition-shadow">
            <Image
              alt="tech-stack"
